...
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][0], data='{"multi":"true","time":"64","success":"7","failure":"3"}'))
statistics[0].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][0], data='{"multi":"true","time":"58","success":"10","failure":"0"}'))
statistics[1].save()
...
statistics[3].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][3], data='{"multi":"false","time":"30","success":"1","failure":"2"}'))
statistics[4].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][4], data='{"multi":"false","time":"612","success":"2","failure":"0"}'))
statistics[5].save()
...
statistics[7].save()
statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[1][0], data='{"multi":"true","time":"127","success":"4","failure":"11"}'))
statistics[8].save()
...
statistics[11].save()
statistics.append(Statistics(user=lp_students[0][3], exercise=exercises[0][4], data='{"multi":"true","time":"301","success":"2","failure":"0"}'))
statistics[12].save()
...
statistics[15].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[0][0], data='{"multi":"true","time":"61","success":"10","failure":"0"}'))
statistics[16].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[0][0], data='{"multi":"false","time":"58","success":"7","failure":"3"}'))
statistics[17].save()
