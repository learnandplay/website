...
school_classes.append(SchoolClass(name='Classe 1', school_name='Ecole primaire Montpellier'))
school_classes[0].save()
school_classes.append(SchoolClass(name='Classe 2', school_name='Ecole primaire Montpellier'))
school_classes[1].save()
school_classes.append(SchoolClass(name='Classe 3', school_name='Ecole primaire Montpellier'))
school_classes[2].save()
school_classes.append(SchoolClass(name='Classe 4', school_name='Ecole primaire Montpellier'))
school_classes[3].save()
school_classes.append(SchoolClass(name='Classe 5', school_name='Ecole primaire Montpellier'))
...
exercises.append([])
exercises[0].append(Exercise(name='Additions simples', subject=subjects[0], reference='maths-additions', data='{"foo": {"value": ["value1", "value2"], "title": "Test select"}, "bar": {"value": "integer", "title": "description integer"}, "result": {"value": "string", "title": "description string"}, "choice": {"value": "bool", "title": "Autoriser multi"}}'))
exercises[0][0].save()
exercises[0].append(Exercise(name='Soustractions', subject=subjects[0], reference='maths-soustractions', data='{"foo": {"value": ["value1", "value2", "value3", "value4"], "default": "value2", "title": "Test select with default value"}, "bar": {"value": "integer", "default": 42, "title": "description integer"}, "result": {"value": "string", "minLength": 4, "maxLength": 12, "default": "maths", "title": "description string"}, "choice": {"value": "bool", "default": false, "title": "Autoriser multi"}}'))
exercises[0][1].save()
exercises[0].append(Exercise(name='Géométrie', subject=subjects[0], reference='maths-geometrie', data='{"foo": {"value": ["value"], "title": "Test select"}, "bar": {"value": "integer", "title": "description integer"}, "result": {"value": "string", "title": "description string"}, "choice": {"value": "bool", "titleMap": ["Autoriser", "Ne pas autoriser"], "title": "Autoriser multi"}}'))
exercises[0][2].save()
exercises[0].append(Exercise(name='Problèmes', subject=subjects[0], reference='maths-problemes', data='{"foo": {"value": ["value1"], "title": "Test select"}, "bar": {"value": "integer", "title": "description integer"}, "result": {"value": "string", "title": "description string"}, "choice": {"value": "bool", "title": "Autoriser multi"}}'))
exercises[0][3].save()

exercises.append([])
exercises[1].append(Exercise(name='Lecture', subject=subjects[1], reference='fr-lecture'))
exercises[1][0].save()
exercises[1].append(Exercise(name='Association lettres', subject=subjects[1], reference='fr-assoc-lettres'))
exercises[1][1].save()

exercises.append([])
exercises[2].append(Exercise(name='Lecture', subject=subjects[2], reference='en-lecture'))
exercises[2][0].save()
exercises[2].append(Exercise(name='Sons', subject=subjects[2], reference='en-sons'))
exercises[2][1].save()
...
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[1][0], data='{"multi":"true","time":"64","success":"7","failure":"3"}'))
statistics[0].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[2][0], data='{"multi":"true","time":"58","success":"10","failure":"0"}'))
statistics[1].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[1][0], data='{"multi":"true","time":"127","success":"4","failure":"11"}'))
statistics[2].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][3], data='{"time":"590","success":"1","failure":"1"}'))
statistics[3].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[2][0], data='{"multi":"false","time":"30","success":"1","failure":"2"}'))
statistics[4].save()
statistics.append(Statistics(user=lp_students[0][0], exercise=exercises[0][3], data='{"multi":"false","time":"612","success":"2","failure":"0"}'))
statistics[5].save()

statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[0][0], data='{"multi":"true","time":"64","success":"7","failure":"3"}'))
statistics[6].save()
statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[2][1], data='{"time":"58","success":"10","failure":"0"}'))
statistics[7].save()
statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[1][1], data='{"multi":"true","time":"127","success":"4","failure":"11"}'))
statistics[8].save()
statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[0][2], data='{"time":"30","success":"1","failure":"2"}'))
statistics[9].save()
statistics.append(Statistics(user=lp_students[1][1], exercise=exercises[0][3], data='{"time":"612","success":"2","failure":"0"}'))
statistics[10].save()

statistics.append(Statistics(user=lp_students[0][3], exercise=exercises[1][0], data='{"time":"98","success":"11","failure":"4"}'))
statistics[11].save()
statistics.append(Statistics(user=lp_students[0][3], exercise=exercises[1][0], data='{"multi":"true","time":"301","success":"2","failure":"0"}'))
statistics[12].save()
statistics.append(Statistics(user=lp_students[0][3], exercise=exercises[0][2], data='{"time":"34","success":"1","failure":"2"}'))
statistics[13].save()

statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[0][0], data='{"multi":"true","time":"74","success":"10","failure":"0"}'))
statistics[14].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[1][0], data='{"time":"71","success":"9","failure":"1"}'))
statistics[15].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[2][0], data='{"multi":"true","time":"61","success":"10","failure":"0"}'))
statistics[16].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[1][1], data='{"multi":"false","time":"58","success":"7","failure":"3"}'))
statistics[17].save()
statistics.append(Statistics(user=lp_students[0][1], exercise=exercises[1][1], data='{"time":"67","success":"10","failure":"0"}'))
statistics[18].save()
